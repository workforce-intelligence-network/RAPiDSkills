class OccupationStandard < ApplicationRecord
  ...
  scope :with_eager_loading, -> { includes(:creator, :occupation, :industry, :pdf_attachment, :excel_attachment, :occupation_standard_skills_with_no_work_process, :occupation_standard_work_processes, :registration_state, organization: [{ logo_attachment: [:blob]}]) }
