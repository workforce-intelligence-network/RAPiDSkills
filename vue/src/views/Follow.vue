  ...
  <div class="page--follow">
    <div class="page--follow__form">
      ...
      <div class="page--follow__text page--follow__form__text page--follow__subtitle">
        Please enter your information so that we can keep you up to date on what is happening with Apprenticeship Skills Builder. We're starting with hybrid and competency-based work processes, first, but we'll support time-based programs soon after.
      </div>
